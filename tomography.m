...
FID = fopen('results_tomo_residual_stopping_kaczparam.dat','a');
FID2 = fopen('results_tomo_residual_stopping_parameters.dat','a');
...
for NoiseLevel = [1e-3,1e-2,1e-1,2e-1,5e-1] %
    close all;
    close all hidden;
    ...
    fprintf(FID,['Eta value:', num2str(options.eta)]);
    tic;
